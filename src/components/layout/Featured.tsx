...
const Featured = () => {
  return (
    <div className="default-margin relative py-30 lg:py-40 flex flex-col gap-12 justify-center items-center">
      ...
      <div className="absolute right-10 top-0 opacity-4 -rotate-40 -z-1">
        <Image src="/images/s4.png" alt="" height={100} width={100} />
      </div>
      <div className="absolute right-0 top-80 opacity-4 rotate-40 -z-1 hidden lg:block">
        <Image src="/images/s3.png" alt="" height={100} width={100} />
      </div>
      <div className="absolute left-40 top-160 opacity-4 rotate-40 -z-1 hidden lg:block">
        <Image src="/images/s2.png" alt="" height={100} width={100} />
      </div>
      <div className="absolute md:left-90 left-0 bottom-10 opacity-4 rotate-40 min-w-[70px] -z-1 lg:hidden">
        <Image src="/images/s2.png" alt="" height={100} width={100} />
      </div>
